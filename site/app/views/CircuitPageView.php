...
HTML;
        ...
        $return .= <<<HTML
        <!-- inject:js -->
        <script src="js/libraries/Camera.js"></script>
        <script src="js/libraries/Clipboard.js"></script>
        <script src="js/libraries/Context.js"></script>
        <script src="js/libraries/CopyUtils.js"></script>
        <script src="js/libraries/HistoryManager.js"></script>
        <script src="js/libraries/Propogation.js"></script>
        <script src="js/libraries/UIDManager.js"></script>
        <script src="js/libraries/Utils.js"></script>
        <script src="js/libraries/actions/Action.js"></script>
        <script src="js/libraries/actions/DeleteAction.js"></script>
        <script src="js/libraries/actions/GroupAction.js"></script>
        <script src="js/libraries/actions/PlaceAction.js"></script>
        <script src="js/libraries/actions/PlaceWireAction.js"></script>
        <script src="js/libraries/actions/SelectAction.js"></script>
        <script src="js/libraries/actions/SplitWireAction.js"></script>
        <script src="js/libraries/actions/TransformAction.js"></script>
        <script src="js/libraries/math/Bezier.js"></script>
        <script src="js/libraries/math/Matrix.js"></script>
        <script src="js/libraries/math/Transform.js"></script>
        <script src="js/libraries/math/Vector.js"></script>
        <script src="js/libraries/popup/Module.js"></script>
        <script src="js/libraries/popup/Popup.js"></script>
        <script src="js/controllers/Exporter.js"></script>
        <script src="js/controllers/Importer.js"></script>
        <script src="js/controllers/Input.js"></script>
        <script src="js/controllers/ItemNavController.js"></script>
        <script src="js/controllers/PlaceItemController.js"></script>
        <script src="js/controllers/SelectionBox.js"></script>
        <script src="js/controllers/SideNavController.js"></script>
        <script src="js/controllers/Tool.js"></script>
        <script src="js/controllers/TransformController.js"></script>
        <script src="js/controllers/WireController.js"></script>
        <script src="js/controllers/contextmenu/ContextMenu.js"></script>
        <script src="js/controllers/contextmenu/CopyModule.js"></script>
        <script src="js/controllers/contextmenu/CutModule.js"></script>
        <script src="js/controllers/contextmenu/PasteModule.js"></script>
        <script src="js/controllers/contextmenu/RedoModule.js"></script>
        <script src="js/controllers/contextmenu/SelectAllModule.js"></script>
        <script src="js/controllers/contextmenu/UndoModule.js"></script>
        <script src="js/controllers/selectionpopup/BusButtonModule.js"></script>
        <script src="js/controllers/selectionpopup/ColorPickerModule.js"></script>
        <script src="js/controllers/selectionpopup/ICButtonModule.js"></script>
        <script src="js/controllers/selectionpopup/InputCountModule.js"></script>
        <script src="js/controllers/selectionpopup/PositionXModule.js"></script>
        <script src="js/controllers/selectionpopup/PositionYModule.js"></script>
        <script src="js/controllers/selectionpopup/SelectionPopup.js"></script>
        <script src="js/controllers/selectionpopup/TitleModule.js"></script>
        <script src="js/controllers/tools/ItemTool.js"></script>
        <script src="js/controllers/tools/SelectionTool.js"></script>
        <script src="js/controllers/tools/WiringTool.js"></script>
        <script src="js/models/IOObject.js"></script>
        <script src="js/models/IOPort.js"></script>
        <script src="js/models/IPort.js"></script>
        <script src="js/models/OPort.js"></script>
        <script src="js/models/Wire.js"></script>
        <script src="js/models/WirePort.js"></script>
        <script src="js/models/ioobjects/Gate.js"></script>
        <script src="js/models/ioobjects/flipflops/SRFlipFlop.js"></script>
        <script src="js/models/ioobjects/gates/ANDGate.js"></script>
        <script src="js/models/ioobjects/gates/BUFGate.js"></script>
        <script src="js/models/ioobjects/gates/ORGate.js"></script>
        <script src="js/models/ioobjects/gates/XORGate.js"></script>
        <script src="js/models/ioobjects/inputs/Button.js"></script>
        <script src="js/models/ioobjects/inputs/Clock.js"></script>
        <script src="js/models/ioobjects/inputs/ConstantHigh.js"></script>
        <script src="js/models/ioobjects/inputs/ConstantLow.js"></script>
        <script src="js/models/ioobjects/inputs/Keyboard.js"></script>
        <script src="js/models/ioobjects/inputs/Switch.js"></script>
        <script src="js/models/ioobjects/other/Decoder.js"></script>
        <script src="js/models/ioobjects/other/Demultiplexer.js"></script>
        <script src="js/models/ioobjects/other/Encoder.js"></script>
        <script src="js/models/ioobjects/other/IC.js"></script>
        <script src="js/models/ioobjects/other/ICData.js"></script>
        <script src="js/models/ioobjects/other/Label.js"></script>
        <script src="js/models/ioobjects/other/Multiplexer.js"></script>
        <script src="js/models/ioobjects/outputs/7SegmentDisplay.js"></script>
        <script src="js/models/ioobjects/outputs/LED.js"></script>
        <script src="js/views/CircuitDesigner.js"></script>
        <script src="js/views/ICDesigner.js"></script>
        <script src="js/views/Main.js"></script>
        <script src="js/views/Renderer.js"></script>
        <!-- endinject -->
    </body>
</html>
HTML;
