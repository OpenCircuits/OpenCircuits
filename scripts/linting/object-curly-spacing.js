...
module.exports = {
    ...
    create(context) {
         ...
         * @returns {void}
         */
        function validateBraceSpacing(node, first, second, penultimate, last, options) {
            ...
            if (astUtils.isTokenOnSameLine(penultimate, last)) {
                ...
                const penultimateType =
                    shouldCheckPenultimate && sourceCode.getNodeByRangeIndex(penultimate.range[0]).type;
        ...
        function checkForObject(node) {
            ...
            validateBraceSpacing(node, first, second, penultimate, last, options);
        }
