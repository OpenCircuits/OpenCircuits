...
import {Oscilloscope} from "core/models/types/analog";

import {RenderInfo}    from "core/views/BaseView";
import {ComponentView} from "core/views/ComponentView";

import {AnalogViewInfo} from "src/app/analog/views/AnalogViewInfo";
...
export class OscilloscopeView extends ComponentView<Oscilloscope, AnalogViewInfo> {
    ...
    protected override renderComponent({ renderer, selections }: RenderInfo): void {
        ...
        const inputs = this.circuit.getPortsFor(this.obj)
            .filter((p) => p.group === AnalogPortGroup.Input).length;     //digital -> Analog ?? 
