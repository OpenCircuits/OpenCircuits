...
export function FindEdge({ input, camera, circuit }: AnalogCircuitInfo): [undefined] {
    // @TODO
    // export function FindEdge({ input, camera, circit }: AnalogCircuitInfo): [undefined] | [Cursor, Vector, Oscilloscope] {
