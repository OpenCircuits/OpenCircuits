...
export const DigitalTranslateTool: Tool = (() => { // elephant TODO figure out how to not copy and paste a whole file for this
		...
		switch (event.type) {
			...
			case "keyup":
				...
				if (event.key === SPACEBAR_KEY) {
					history.add(new DigitalCopyGroupAction(designer, components).execute());
					return true;
				}
				break;
		}
