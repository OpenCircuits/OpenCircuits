...
export class BUFGateAssembler extends Assembler<Schema.Component> {
    ...
    public constructor(circuit: CircuitInternal, view: CircuitView, selections: SelectionsManager, sim: DigitalSim) {
        ...
        this.img = view.options.getImage("buf.svg")!;
    ...
    private assembleLine(gate: Schema.Component) {
        ...
        const { inputPortGroups } = this.circuit.getObjectInfo("BUFGate") as DigitalComponentInfo;
