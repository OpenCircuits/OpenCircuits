...
export class JKFlipFlopView extends ComponentView<JKFlipFlop, DigitalCircuitController> {
    public constructor(circuit: DigitalCircuitController, obj: JKFlipFlop) {
        super(circuit, obj, V(2, 3), "base.svg");
    }
