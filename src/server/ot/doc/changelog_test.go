...
func TestChangelogAddMultiple(t *testing.T) {
	...
	tests := []struct {
		...
		{ProposedEntry{[]byte{}, 0, 0, "TEST0", "ASDF"}, Want{0, nil}},
		{ProposedEntry{[]byte{}, 1, 0, "TEST0", "ASDF"}, Want{1, nil}},
		{ProposedEntry{[]byte{}, 3, 0, "TEST0", "ASDF"}, Want{0, errors.New("")}},
		{ProposedEntry{[]byte{}, 0, 0, "TEST0", "ASDF"}, Want{2, nil}},
	}
...
func smallChangelog() Changelog {
	l := Changelog{}
	l.AddEntry(ProposedEntry{[]byte{}, 0, 0, "", ""})
	l.AddEntry(ProposedEntry{[]byte{}, 1, 0, "", ""})
	l.AddEntry(ProposedEntry{[]byte{}, 2, 0, "", ""})
	l.AddEntry(ProposedEntry{[]byte{}, 3, 0, "", ""})
