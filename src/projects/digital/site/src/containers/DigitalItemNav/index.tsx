...
export const DigitalItemNav = () => {
    ...
    const additionalPreview = useCallback(
        (smartPlace: SmartPlaceOptions, curItemKind: string) => {
            ...
            const {
                defaultPortConfig: config,
                inputPortGroups,
                outputPortGroups,
            } = circuit.getComponentInfo(curItemKind)!;
    ...
    const onDelete = useCallback(
        (sec: ItemNavSection, ic: ItemNavItem) => {
            const id = ic.kind;
