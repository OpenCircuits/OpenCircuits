...
export const ICDesigner = () => {
    ...
    const { isActive, objIds } = useDigitalSelector((state) => ({ ...state.icDesigner }));
    ...
    useLayoutEffect(() => {
        ...
        const designer = CreateDesigner(
            {
                defaultTool: new DefaultTool(FitToScreenHandler, RedoHandler, UndoHandler, ZoomHandler),
                tools: [new PanTool(), new ICResizeTool(ic.id, icInstance.id), new ICPortTool(ic.id, icInstance.id)],
            },
            [],
            DRAG_TIME,
            circuit,
        ...
        const cleanup2 = designer.circuit.subscribe(() => setICName(designer.circuit.getICs()[0].name));
