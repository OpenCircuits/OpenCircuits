...
export type TokenType = InputTreeOpType | ParenType;

/** Represents that a "binary" operation can have 2-8 children. */
export type BinOpChildren = [
    InputTree,
    InputTree,
    InputTree?,
    InputTree?,
...
export type InputTree = InputTreeIdent | InputTreeUnOpNode | InputTreeBinOpNode;
...
export type Token = OpToken | InputToken;
