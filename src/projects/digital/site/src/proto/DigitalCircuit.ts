    ...
    fromJSON(object: any): DigitalSimState {
        return {
            signals: globalThis.Array.isArray(object?.signals)
                ? object.signals.map((e: any) => globalThis.Number(e))
                : [],
...
export const DigitalSimState_State: MessageFns<DigitalSimState_State> = {
    ...
    fromJSON(object: any): DigitalSimState_State {
        return {
            state: globalThis.Array.isArray(object?.state) ? object.state.map((e: any) => globalThis.Number(e)) : [],
        };
    },
...
export const DigitalCircuit: MessageFns<DigitalCircuit> = {
    ...
    fromPartial<I extends Exact<DeepPartial<DigitalCircuit>, I>>(object: I): DigitalCircuit {
        const message = createBaseDigitalCircuit();
        message.circuit =
            object.circuit !== undefined && object.circuit !== null ? Circuit.fromPartial(object.circuit) : undefined;
        ...
        message.simState =
            object.simState !== undefined && object.simState !== null
