...
describe("WiringTool", () => {
    test("Click to Connect Switch -> LED", () => {
        ...
        input.click(sw.outputs[0].targetPos).click(led.inputs[0].targetPos);
    ...
    test("Drag to Connect Switch -> LED", () => {
        ...
        input.drag(sw.outputs[0].targetPos, led.inputs[0].targetPos);
    ...
    test("Click to Connect LED -> Switch (other direction)", () => {
        ...
        input.click(led.inputs[0].targetPos).click(sw.outputs[0].targetPos);
    ...
    test("Drag to Connect LED -> Switch (other direction)", () => {
        ...
        input.drag(led.inputs[0].targetPos, sw.outputs[0].targetPos);
    ...
    test("Connect Switch to Multiple LEDs", () => {
        ...
        input.drag(sw.outputs[0].targetPos, led1.inputs[0].targetPos);
        input.drag(sw.outputs[0].targetPos, led2.inputs[0].targetPos);
    ...
    test("Try to Connect LED to Multiple Inputs", () => {
        ...
        input.drag(led.inputs[0].targetPos, sw1.outputs[0].targetPos);
        input.click(sw2.outputs[0].targetPos).click(led.inputs[0].targetPos);
    ...
    test("Click from Node to Input Port", () => {
        ...
        input.click(node.pos).click(g.inputs[1].targetPos);
