...
export function CreateTestCircuitHelpers(circuit: DigitalCircuit) {
    const helpers = {
        ...
        Connect: (
            o1: DigitalComponent | DigitalPort | DigitalPort[],
            o2: DigitalComponent | DigitalPort | DigitalPort[],
        ): DigitalWire | undefined => {
            if (Array.isArray(o1) || Array.isArray(o2)) {
                return helpers.Connect(Array.isArray(o1) ? o1[0] : o1, Array.isArray(o2) ? o2[0] : o2);
            }
...
export function CreateTestCircuit(sim = true): [DigitalCircuit, ReturnType<typeof CreateTestCircuitHelpers>] {
    ...
    if (sim) circuit["ctx"].simRunner = new InstantSimRunner(circuit["ctx"].sim);
