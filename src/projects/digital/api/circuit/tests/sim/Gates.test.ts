...
describe("Gates", () => {
    ...
    describe("ANDGate", () => {
        test("Basic", () => {
            ...
            expect(out).toBeOff();
            const [sw3] = Place("Switch");
            Connect(sw3, gate.inputs[2]);
            expect(out).toBeOff();
            TurnOn(sw3);
            expect(out).toBeOn();
