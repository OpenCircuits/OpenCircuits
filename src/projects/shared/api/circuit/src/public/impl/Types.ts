    ...
    T extends Vector
        ...
        : T extends Rect
          ...
          : // Base-type replacements
            T extends IntegratedCircuit
            ? Types["IntegratedCircuitT"]
            : T extends Circuit
              ? Types["CircuitT"]
              : T extends Node
                ? Types["NodeT"]
                : T extends Component
                  ...
                  : T extends Wire
                    ...
                    : T extends Port
                      ? Types["PortT"]
                      : T extends ObjContainer
                        ? Types["ObjContainerT"]
                        : T extends Selections
                          ? Types["SelectionsT"]
                          : T extends ComponentInfo
                            ? Types["ComponentInfoT"]
                            : T extends ICInfo
                              ? Types["ICInfoT"]
                              : // Base-Readonly-type replacements
                                T extends ReadonlyIntegratedCircuit
                                ? Types["ReadonlyIntegratedCircuitT"]
                                : T extends ReadonlyCircuit
                                  ? Types["ReadonlyCircuitT"]
                                  : T extends ReadonlyNode
                                    ? Types["ReadonlyNodeT"]
                                    : T extends ReadonlyComponent
                                      ? Types["ReadonlyComponentT"]
                                      : T extends ReadonlyWire
                                        ? Types["ReadonlyWireT"]
                                        : T extends ReadonlyPort
                                          ? Types["ReadonlyPortT"]
                                          : T extends ReadonlyObjContainer
                                            ? Types["ReadonlyObjContainerT"]
                                            : T extends ReadonlySelections
                                              ? Types["ReadonlySelectionsT"]
                                              : // Replace all method args/return types
                                                T extends (...a: infer Args) => infer R
                                                ? (...a: ReplaceAPITypes<Args, Types>) => ReplaceAPITypes<R, Types>
                                                : // Recursively replace records
                                                  T extends Record<string | number, unknown>
                                                  ? { [key in keyof T]: ReplaceAPITypes<T[key], Types> }
                                                  : // Replace arrays
                                                    T extends unknown[]
                                                    ? { [Index in keyof T]: ReplaceAPITypes<T[Index], Types> }
