...
describe("WiringTool", () => {
    ...
    test("Click to Connect Comp -> Comp (other direction)", () => {
        ...
        input.click(GetPort(obj2).targetPos).click(GetPort(obj1).targetPos);
    ...
    test("Drag to Connect Comp -> Comp (other direction)", () => {
        ...
        input.drag(GetPort(obj2).targetPos, GetPort(obj1).targetPos);
    ...
    test("Connect Comp to Multiple Comps", () => {
        ...
        input.drag(GetPort(obj1).targetPos, GetPort(obj2).targetPos);
        input.drag(GetPort(obj1).targetPos, GetPort(obj3).targetPos);
