...
export const HeaderLeft = () => {
    ...
    const { id, name, isSaved, isLocked, isLoggedIn, isHistoryBoxOpen, saving, error } = useSharedSelector((state) => ({
        ...state.circuit,
    ...
    return (
        <div className="header__left">
            ...
            >
                ...
                />
                <img src={lockIcon} className={isLocked ? "" : "hide"} width="18px" height="18px" alt="Icon for lock" />
            </button>
            ...
            <img
                ...
                title={`Error occured while saving: ${error}`}
                alt="Icon when save failed"
            />
