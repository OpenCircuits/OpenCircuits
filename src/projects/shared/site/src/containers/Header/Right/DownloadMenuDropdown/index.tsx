...
export const DownloadMenuDropdown = () => {
    ...
    const { curMenu, circuitName } = useSharedSelector((state) => ({
    ...
    return (
        ...
        >
            <div role="button" tabIndex={0} title="Download circuit locally" onClick={onDownloadClick}>
