...
export const ImageExporterPopup = ({ designer, extraHandlers }: Props) => {
    const { curPopup, circuitName } = useSharedSelector((state) => ({
        curPopup: state.header.curPopup,
    ...
    return (
        ...
        >
            <div className="imageexporter__popup">
                <div ref={wrapper} className={`imageexporter__popup__canvas-wrapper ${state.useBg ? "" : "checkered"}`}>
                    {isActive && (
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                />
                                <span>
                                    <button type="button" onClick={() => setState({ ...state, bgColor: "#cccccc" })}>
                                        Reset
                                    </button>
                                </span>
                            </div>
...
const ImageExporterPreview = ({
    ...
    return (
        <>
            ...
            />
            <canvas ref={canvas} width={`${width}px`} height={`${height}px`} style={style} />
        </>
    );
};
