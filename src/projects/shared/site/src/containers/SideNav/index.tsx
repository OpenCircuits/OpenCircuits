...
export const SideNav = ({ exampleCircuits }: Props) => {
    ...
    const { auth, circuits, isOpen, loading, isSaved, loadingCircuits } = useSharedSelector((state) => ({
        ...state.user,
        ...
        <>
            ...
            <div className={`sidenav ${isOpen ? "" : "sidenav__move"}`}>
                <div className="sidenav__accountinfo">
                    <div className="sidenav__accountinfo__name">{auth ? `Hello, ${auth.getName()}!` : undefined}</div>
                ...
                <div className="sidenav__content">
                    ...
                    <div className="sidenav__content__footer">
                        ...
                        <a href="https://leonmontealeg.re/" target="_blank" rel="noopener noreferrer">
                            Leon Montealegre{" "}
                        </a>
                        and our great{" "}
                        <a
                            href="https://www.github.com/OpenCircuits/OpenCircuits/blob/master/AUTHORS.md"
                            target="_blank"
