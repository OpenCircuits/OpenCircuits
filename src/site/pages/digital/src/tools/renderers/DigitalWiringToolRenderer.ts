...
import {ToolRendererProps}  from "shared/tools/renderers/ToolRenderer"
...
export class DigitalWiringToolRenderer extends WiringToolRenderer {
    protected override getColor({ options, curTool }: ToolRendererProps<WiringTool>): string | undefined  {
