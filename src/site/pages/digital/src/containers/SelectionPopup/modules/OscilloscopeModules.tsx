...
//     getAction: (s, newNumSamples) => new GroupAction(s.map(o => new OscilloscopeSamplesChangeAction(o, newNumSamples)), "Oscilloscope Samples Change Module")
// }
...
//         new GroupAction(s.map(o => new InputPortChangeAction(o, o.getInputPortCount().getValue(),  newCount)), "Oscilloscope Input Count Change Module")
//     )
// }
...
//     getAction: (s, newW) => (
//         new GroupAction(s.map(o => new OscilloscopeSizeChangeAction(o, V(newW, o.getDisplaySize().y))), "Oscilloscope Width Change Module")
//     )
// }
...
//     getAction: (s, newH) => (
//         new GroupAction(s.map(o => new OscilloscopeSizeChangeAction(o, V(o.getDisplaySize().x, newH))), "Oscilloscope Height Change Module")
//     )
// }
