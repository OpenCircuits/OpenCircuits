    ...
    <footer className="pt-4 my-md-5 pt-md-5 border-top">
        ...
        <div className="col-6 col-md">
            ...
            <ul className="list-unstyled text-small">
                ...
                <li><a className="text-muted" href={DOCS_URL} target="_blank">Documentation</a></li>
                <li><a className="text-muted" href={GITHUB_URL} target="_blank">Contribute</a></li>
            </ul>
        </div>
        <div className="col-6 col-md">
            <h5>About</h5>
            <ul className="list-unstyled text-small">
                <li><a className="text-muted" href={AUTHORS_URL} target="_blank">Team</a></li>
