import {SHIFT_KEY} from "analog/utils/Constants";
...
import {GetAllPorts} from "analog/utils/ComponentUtils";
...
export class SelectionBox {
    ...
    public constructor(designer: EECircuitDesigner, camera: Camera, selectionTool: SelectionTool) {
