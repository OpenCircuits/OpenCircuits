...
import {Action} from "analog/actions/Action";
...
export class ToolManager implements MouseListener, KeyboardListener {
    ...
    public constructor(camera: Camera, designer: EECircuitDesigner) {
    ...
    public placeComponent(component: EEComponent, instant: boolean = false): void {
