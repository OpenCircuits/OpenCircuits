...
<pre>
    src/ &nbsp;projects/ &nbsp;&nbsp;myproject/ &nbsp;&nbsp;&nbsp;api/ &nbsp;&nbsp;&nbsp;&nbsp;circuit/
    &nbsp;&nbsp;&nbsp;&nbsp;circuitdesigner/ &nbsp;&nbsp;&nbsp;site/
</pre>
...
Once you've defined the _data_ and _behavior_ of your components, you need to define how they _look_. This is the job of **Component Assemblers**.
